...
-- Dual class name mapping - extracted from server's actual classes
local DUAL_CLASS_MAPPING = {
    ...
    -- Death Knight combinations
    ["Summoner"] = "SUMMONER",
    ["Lich"] = "LICH",
    ["Necromancer"] = "NECROMANCER",
    ["Dreadweaver"] = "DREADWEAVER",
...
-- Add dual class mappings
for displayName, classToken in pairs(DUAL_CLASS_MAPPING) do
	BC[displayName] = classToken
end

local function GetClassColors()
    if CUSTOM_CLASS_COLORS then
        -- Merge base classes with custom dual classes
        local merged = {}
    ...
    return RAID_CLASS_COLORS
end

local RAID_CLASS_COLORS = GetClassColors()
...
if CUSTOM_CLASS_COLORS then
	CUSTOM_CLASS_COLORS:RegisterCallback(function()
        -- Refresh the merged class colors
        RAID_CLASS_COLORS = GetClassColors()
